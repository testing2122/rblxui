...
local clrs = {
    ...
    pink = Color3.fromRGB(255, 0, 255), -- Updated to match UI
    red = Color3.fromRGB(255, 80, 80),
    darkpink = Color3.fromRGB(200, 0, 200),
    lightpink = Color3.fromRGB(255, 100, 255),
...
function components:AddColorWheel(parent, cfg)
    ...
    wheelframe.Size = UDim2.new(1, 0, 0, desc ~= "" and 285 or 265);
